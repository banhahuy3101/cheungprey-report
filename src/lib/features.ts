...
export const FEATURES: Feature[] = [
  ...
  { key: "commune-evaluation", labelKh: "វាយតម្លៃឃុំ/សង្កាត់", labelEn: "Commune Evaluation", description: "វាយតម្លៃប្រចាំខែ", icon: "ClipboardCheck", route: "/dashboard/commune-evaluation", permissionKey: "", sortOrder: 5 },
