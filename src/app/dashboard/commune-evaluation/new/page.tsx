...
function generateRandomData(): EvaluationData {
  return {
    ...
    hasCommunityCulturalSpace: randChoice(["មាន", "គ្មាន"]),
    ...
    hasTrafficManagement: randChoice(["មាន", "គ្មាន"]),
    trafficSignsStatus: randChoice(["គ្រប់គ្រាន់", "មិនទាន់គ្រប់គ្រាន់", "គ្មាន"]),
    trafficAccidentCases: randNum(0, 20),
    orderlyPlaces: randNum(1, 15),
    disorderlyPlaces: randNum(0, 10),
    hasPublicParking: randChoice(["មាន", "គ្មាន"]),
    ...
    hasCouncilMemberSchoolCommittee: randChoice(["មាន", "គ្មាន"]),
    hasDistrictMemberSchoolCommittee: randChoice(["មាន", "គ្មាន"]),
    schoolMeetingCount: randNum(1, 12),
    hasTeacherSupport: randChoice(["មាន", "គ្មាន"]),
    ...
    hasHealthCenter: randChoice(["មាន", "គ្មាន"]),
    hasReferralHospital: randChoice(["មាន", "គ្មាន"]),
    hasDoctorIncentives: randChoice(["មាន", "គ្មាន"]),
    doctorSupportDetails: randChoice(["ប្រាក់ឧបត្ថម្ភ", "ផ្ទះស្នាក់នៅ"]),
    hasCommunityHealthParticipation: randChoice(["មាន", "គ្មាន"]),
    hasPublicExerciseSpace: randChoice(["មាន", "គ្មាន"]),
    ...
    hasDroughtPumping: randChoice(["មាន", "គ្មាន"]),
    electricityCoveragePct: randNum(50, 100),
    hasCommuneWebsite: randChoice(["មាន", "គ្មាន"]),
    hasHealthCenterWebsite: randChoice(["មាន", "គ្មាន"]),
    hasSchoolWebsite: randChoice(["មាន", "គ្មាន"]),
    hasPoliceWebsite: randChoice(["មាន", "គ្មាន"]),
    landDisputeCases: randNum(0, 20),
    hasLandUsePlan: randChoice(["មាន", "គ្មាន"]),
    targetCommunities: randNum(1, 10),
    hasWasteCollection: randChoice(["មាន", "គ្មាន"]),
    environmentalLawPrograms: randNum(1, 10),
    environmentalLawParticipants: randNum(30, 300),
    greenVillagePrograms: randNum(1, 10),
    hasGreenVillageProgram: randChoice(["មាន", "គ្មាន"]),
    foodSafetyPrograms: randNum(1, 10),
    foodPoisoningCases: randNum(0, 10),
    hasEmergencyResponse: randChoice(["មាន", "គ្មាន"]),
    hasDisasterPreparedness: randChoice(["មាន", "គ្មាន"]),
    hasHumanRightsProtection: randChoice(["មាន", "គ្មាន"]),
    smallBusinessesCount: randNum(10, 100),
    registeredSmallBusinesses: randNum(5, 80),
    hasFinancialLiteracy: randChoice(["បាន", "មិនបាន"]),
    hasYouthSkillsTraining: randChoice(["មាន", "គ្មាន"]),
    hasCommunityMarket: randChoice(["មាន", "គ្មាន"]),
    ...
    hasReceivedIncentives: randChoice(["មាន", "គ្មាន"]),
