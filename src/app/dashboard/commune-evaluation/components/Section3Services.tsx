...
export default function Section3Services({ data }: Section3Props) {
  return (
    <table className="w-full border-collapse border border-black border-t-0">
      <tbody>
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#B4C6E7]">៣</td>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.១</td>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.២</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
            សេវាអប់រំ
          </td>
        </tr>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៣</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
            សេវាសុខាភិបាល
          </td>
        </tr>
        ...
        <tr data-pb="true">
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៤</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៥</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៦</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr data-pb="true">
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៧</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៨</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.៩</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr data-pb="true">
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.១០</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap bg-[#E8EDF8]">៣.១១</td>
          <td className="border border-black border-t-0 p-1 font-siemreap bg-[#E8EDF8]" colSpan={2}>
