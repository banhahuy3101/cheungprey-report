...
export default function Section3Services({ data }: Section3Props) {
  return (
    <table className="w-full border-collapse border border-black border-t-0">
      <tbody>
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣</td>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.១</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            សេវារដ្ឋបាល
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១.១</td>
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១.២</td>
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១.៤</td>
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.២</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            សេវាអប់រំ
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.២.៥</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
            ...
            <ol className="pl-5 space-y-1">
              <li>១. 
                ...
                <label className="inline-flex items-center gap-1 cursor-not-allowed">
                  {data.hasCouncilMemberSchoolCommittee === "គ្មាន" ? "☑" : "☐"}
                  គ្មាន
                </label>
              </li>
              <li>២. 
                ...
                <label className="inline-flex items-center gap-1 cursor-not-allowed">
                  {data.hasDistrictMemberSchoolCommittee === "គ្មាន" ? "☑" : "☐"}
                  គ្មាន
                </label>
              </li>
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.២.៦</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.២.៨</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៣</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            សេវាសុខាភិបាល
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៣.២</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៣.៦</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
          ...
          <td className="border border-black w-[40%] font-siemreap pr-4 text-justify align-top">
            <ol className="pl-5 space-y-1">
              ...
              <li>២. 
                ...
                <label className="inline-flex items-center gap-1 cursor-not-allowed">
                  {data.hasReferralHospital === "គ្មាន" ? "☑" : "☐"}
                  គ្មាន
                </label>
              </li>
            </ol>
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៣.៧</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
          ...
          <td className="border border-black w-[40%] font-siemreap pr-4 text-justify align-top">
            <ol className="pl-5 space-y-1">
              <li>១. 
                ...
                <label className="inline-flex items-center gap-1 cursor-not-allowed">
                  {data.hasDoctorIncentives === "គ្មាន" ? "☑" : "☐"}
                  គ្មាន
                </label>
              </li>
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៣.៩</td>
          <td className="border border-black font-siemreap p-3">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasPublicExerciseSpace === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៣.១០</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៤</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការកសាងហេដ្ឋារចនាសម្ព័ន្ធ កសាងរចនាសម្ព័ន្ធសហគមន៍
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៤.១</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៤.២</td>
          <td className="border border-black font-siemreap p-3">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៤.៣</td>
          <td className="border border-black font-siemreap p-3">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៤.៤</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៥</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការផ្គត់ផ្គង់ទឹកស្អាត
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៥.១</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៥.២</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៦</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការរក្សាប្រភពទឹក និងការពង្រីកប្រព័ន្ធស្រោចស្រព
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.១</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.២</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.៤</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.៥</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.៦</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.៧</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៦.៨</td>
          <td className="border border-black p-3 font-siemreap">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasDroughtPumping === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៧</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការផ្គត់ផ្គង់ថាមពលអគ្គិសនី
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៧.១</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៨</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            បច្ចេកវិទ្យា គមនាគមន៍ និងព័ត៌មាន
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៨.៣</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
          ...
          <td className="border border-black w-[40%] font-siemreap pr-4 text-justify align-top">
            <ol className="pl-5 space-y-1">
              ...
              <li>២. 
                ...
                <label className="inline-flex items-center gap-1 cursor-not-allowed">
                  {data.hasHealthCenterWebsite === "គ្មាន" ? "☑" : "☐"}
                  គ្មាន
                </label>
              </li>
              <li>៣. 
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.៩</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការគ្រប់គ្រងដីធ្លី សំណង់ ការរៀបចំដែនដី និងនគរូបនីយកម្ម
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៩.៤</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៩.៥</td>
          <td className="border border-black p-3 font-siemreap">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasLandUsePlan === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.៩.៧</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.១០</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការងារអនាម័យ និងបរិស្ថាន
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១០.១</td>
          <td className="border border-black p-3 font-siemreap">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasWasteCollection === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១០.២</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១០.៣</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
          ...
          <td className="border border-black w-[40%] font-siemreap pr-4 text-justify align-top">
            <ol className="pl-5 space-y-1">
              ...
              <li>២. 
                ...
                <label className="inline-flex items-center gap-1 cursor-not-allowed">
                  {data.hasGreenVillageProgram === "គ្មាន" ? "☑" : "☐"}
                  គ្មាន
                </label>
              </li>
            </ol>
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១០.៤</td>
          <td className="border border-black font-siemreap">
            <ol className="pl-5 space-y-1">
        ...
        <tr>
          <td className="border border-black border-t-0 w-20 p-1 text-center font-siemreap">៣.១១</td>
          <td className="border border-black border-t-0 p-3 font-siemreap" colSpan={2}>
            ការបង្ការ និងការទប់ស្កាត់ការប្រើប្រាស់សារធាតុ គ្រឿងញៀន និងការឆ្លងជំងឺមហារីក
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១១.១</td>
          <td className="border border-black p-3 font-siemreap">
        ...
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១១.២</td>
          <td className="border border-black p-3 font-siemreap">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasEmergencyResponse === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១១.៣</td>
          <td className="border border-black p-3 font-siemreap">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasDisasterPreparedness === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
        <tr>
          <td className="border border-black w-20 p-1 text-center font-siemreap align-top">៣.១១.៤</td>
          <td className="border border-black p-3 font-siemreap">
          ...
          <td className="border border-black w-[40%] pl-5 pr-4 font-siemreap text-justify align-top">
            ...
            <label className="inline-flex items-center gap-1 cursor-not-allowed">
              {data.hasHumanRightsProtection === "គ្មាន" ? "☑" : "☐"}
              គ្មាន
            </label>
          </td>
        </tr>
