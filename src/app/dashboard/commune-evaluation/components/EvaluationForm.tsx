...
export default forwardRef<EvaluationFormHandle, EvaluationFormProps>(function EvaluationForm({
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>១. លទ្ធិប្រជាធិបតេយ្យ និងសិទ្ធិសេរីភាព</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>២. សន្តិសុខ របៀបរៀបរយ និងសណ្តាប់ធ្នាប់សាធារណៈ</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>៣. សេវាសាធារណៈ</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              <SelectField label="មានការចូលរួមែទាំសុខភាពសហគមន៍" value={form.hasCommunityHealthParticipation} onChange={(v) => update("hasCommunityHealthParticipation", v)} options={yesNoOptions} />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>៣.៤ ហេដ្ឋារចនាសម្ព័ន្ធ</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>៣.៥-៣.១១ ទឹក ថាមពល បច្ចេកវិទ្យា ដីធ្លី បរិស្ថាន គ្រោះធម្មជាតិ</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>៤. សេដ្ឋកិច្ចមូលដ្ឋាន</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>៥. ការគាំពារសង្គម</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>៦. លទ្ធិប្រជាធិបតេយ្យ និងយុត្តិធម៌សង្គម</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Card>
        <CardHeader>
          <CardTitle>៧. ស្វ័យភាព សិទ្ធិអំណាច មុខងារ និងធនធាន</CardTitle>
        </CardHeader>
        <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
