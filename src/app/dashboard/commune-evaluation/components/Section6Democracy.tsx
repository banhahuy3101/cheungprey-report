  ...
  return (
    <table className="w-full border-collapse border border-black border-t-0">
      ...
      <tbody><tr>
          ...
          <td className="border border-black p-1 font-siemreap text-xs">ភាគរយនៃការដោះស្រាយវិវាទនៅមូលដ្ឋានដោយឃុំ សង្កាត់</td>
          <td className="border border-black w-[45%] p-1 font-siemreap text-xs text-justify align-top">
          ...
          <td className="border border-black p-1 font-siemreap text-xs">ឃុំ សង្កាត់ធ្លាប់បានទទួលការលើកទឹកចិត្ត និងរង្វាន់លើកទឹកចិត្ត</td>
          <td className="border border-black w-[45%] p-1 font-siemreap text-xs text-justify align-top">
