...
const rows_7_1: DataRow[] = [
  {
    id: "៧.១.១",
    indicator: "ចំនួនសំណើសំណូមពរ និងក្តីកង្វល់នានារបស់ប្រជាពលរដ្ឋដែលក្រុមប្រឹក្សាឃុំ សង្កាត់ពុំអាចដោះស្រាយបានជម្រុញមករដ្ឋបាលក្រុង ស្រុក ខណ្ឌ រដ្ឋបាលរាជធានី ខេត្ត និងក្រសួង ស្ថាប័នថ្នាក់ជាតិ ដើម្បីដោះស្រាយ",
...
const rows_7_2: DataRow[] = [
  ...
  {
    id: "៧.២.៤",
    indicator: "ចំនួនគម្រោងរបស់ឃុំ សង្កាត់ដែលបានបញ្ច្រាបភាពធន់នឹងការប្រែប្រួលអាកាសធាតុទៅក្នុងប្រព័ន្ធគ្រប់គ្រងការងារ ការផ្ដល់សេវាសាធារណៈ និងការអភិវឌ្ឍហេដ្ឋារចនាសម្ព័ន្ធមូលដ្ឋាន",
  ...
  {
    id: "៧.២.៨",
    indicator: "ឃុំ សង្កាត់ដែលបានចូលរួមគ្រប់គ្រងសំរាម សំណល់រឹង និងបញ្ហាបរិស្ថានផ្សេងទៀតក្នុងមូលដ្ឋានរបស់ខ្លួន",
    render: (d) => (
      <>
        <label className="inline-flex items-center gap-1 mr-4 cursor-not-allowed">
  ...
  {
    id: "៧.២.៩",
    indicator: "ឃុំ សង្កាត់ដែលបានចូលរួមគ្រប់គ្រងសំរាម សំណល់រឹង និងបញ្ហាបរិស្ថានផ្សេងទៀតក្នុងមូលដ្ឋានរបស់ខ្លួនបានដូចជា",
    render: (d) => (
  ...
  {
    id: "៧.២.១៧",
    indicator: "មុខងារចាំបាច់ផ្សេងៗទៀត ដែលឃុំ សង្កាត់បានអនុវត្ដដើម្បីឆ្លើយតបទៅនឹងតម្រូវការចាំបាច់របស់ប្រជាពលរដ្ឋនៅមូលដ្ឋាន",
    render: (d) => (
      <div className="whitespace-pre-line min-h-[3rem]">
...
const rows_7_3: DataRow[] = [
  ...
  {
    id: "៧.៣.២",
    indicator: "ចំនួនថវិកាឃុំ សង្កាត់កៀរគរបាន",
